  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        speaker2:
          "url('https://images.unsplash.com/photo-1598966739654-5e9a252d8c32?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80')",
        speaker3:
